...
angular.module('Sonnets', ['ngSanitize', 'ui.bootstrap']).controller('AppCtrl', function($scope, $document, $http) {
...
angular.module('Sonnets').directive('annotations', function($compile) {
  return {
    restrict: 'A',
