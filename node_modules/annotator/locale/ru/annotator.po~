...
"POT-Creation-Date: 2011-10-30 16:17+0000\n"
"PO-Revision-Date: 2011-10-30 15:57+0100\n"
"Last-Translator: Nick Stenning <>\n"
...
msgstr "Annotator требует jQuery: Пожалуйста? добавьте lib/vendor/.js"
...
#: lib/range.js:11
#, fuzzy
msgid "Couldn't not sniff range type"
msgstr "Не удалось обнаружить тип диапазона"

#: lib/range.js:26
msgid "You may only call normalize() once on a BrowserRange!"
msgstr "Только один вызов 'нормализовать'  разрешается на BrowserRange"
...
msgstr ""
"Предупреждение: Никакой идентификатор для этой аннотации не вернулся из "
"сервера"
...
msgstr ""
"Чтобы использовать плагин Markdown, вы должны в первую очередь включить "
"Showdown в страницу."
...
msgstr ""
"Любой пользователь может &lt;strong&gt;видеть&lt;/strong&gt; эту аннотацию"
...
#~ msgid "Allow anyone to &lt;strong&gt;edit&lt;/&gt; this annotation"
#~ msgstr ""
#~ "Любой пользователь может &lt;strong&gt;редактировать &lt;/&gt; эту "
#~ "аннотацию"

#~ msgid "another function"
#~ msgstr "другая функция"
